...
public class Board extends JPanel implements ActionListener, KeyListener {
    ...
    private void drawScore(Graphics g) {
        ...
        String text = "Movements: " + player.getScore();
    ...
    private ArrayList<Potion> populateCoins() {
        ...
        for (int i = 0; i < NUM_COINS; i++) {
            ...
            potionList.add(new Potion(coinX, coinY));
        }
    ...
    private void collectCoins() {
        ...
        ArrayList<Potion> collectedPotions = new ArrayList<>();
        for (Potion potion : potions) {
        ...
        potions.removeAll(collectedPotions);
    }
